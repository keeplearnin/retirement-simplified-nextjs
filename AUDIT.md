...
| 4 | GrowthProjector.jsx:79-86 | **SS early claiming reduction uses flat rate** — Uses 0.556%/month for all months early. Real formula: 5/9% for first 36 months, 5/12% for months beyond. At age 62 (60 months early), underestimates benefit by ~3.3%. | todo (same bug fixed in SocialSecurity.jsx in `73f3518`; GrowthProjector still has it) |
