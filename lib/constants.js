...
// Market assumptions
export const DEFAULT_RETURN = 0.07;       // 7% average annual return
export const DEFAULT_STD_DEV = 0.15;      // 15% standard deviation
export const DEFAULT_INFLATION = 2.5;     // 2.5% annual inflation
export const LONG_TERM_CAP_GAINS_RATE = 0.15; // 15% for most brackets
export const RMD_START_AGE = 73;          // SECURE Act 2.0
export const LOSS_DEDUCTION_LIMIT = 3000; // Annual loss deduction vs ordinary income

// Social Security bend points (2025)
export const SS_WAGE_CAP = 168600;
export const SS_BEND_POINTS = [1174, 7078];
export const SS_FACTORS = [0.9, 0.32, 0.15];
export const SS_FRA = 67; // Full Retirement Age
...
export const REPLACEMENT_FUNDS = {
